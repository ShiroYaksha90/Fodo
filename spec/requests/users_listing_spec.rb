...
RSpec.describe 'UsersListings', type: :request do
  describe 'GET /users_listings' do
    it 'lists all users' do
      @admin_user = User.create!(name: 'Example User', email: 'example@exampel.com', password: 'password',
                                 password_confirmation: 'password', admin: true)
      @user2 = User.create!(name: 'Example User2', email: 'example2@exampel.com', password: 'password',
