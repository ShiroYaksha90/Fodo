...
RSpec.feature 'UsersSignups', type: :feature do
  ...
  scenario 'renders signup page with errors' do
    ...
    expect(page).to have_selector('div.alert.alert-danger.alert-dismissible',
                                  text: 'Prevented this User from being saved')
  ...
  scenario 'successfully creates a new user' do
    ...
    expect(page).to have_selector('h4', text: 'No recipes yet')
  end
end
